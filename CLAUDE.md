...
- **Próxima aula**: A58 (24/09), 6 HA, **UC01 fecha e ponto final**: painel parte 2, conferência na mesa e menção lançada (conteúdo que era da A57). **Jogos escolares** derrubaram a semana de 17/09: A56 valeu meio dia (3 HA) e A57 (18/09) foi **cancelada**. Depois vem **A59 (25/09): abre o épico 2, Banco de Dados**, A59 e A60 só com o Indicador 5 (consultas SQL no sqliteonline sobre o dado de dengue que a turma limpou)
...
- ⚠️ **Banco de Dados abre com 3 dias de preparo**: o ambiente dos Indicadores 4 (permissões) e 6 (backup) precisa estar decidido no épico **até 30/09**, porque o SQLite não tem `GRANT`/`REVOKE`
