...
# ─────────────────────────────────────────────────────────────────
theme: ../../slidev-theme-neural  # não alterar — aponta para o tema na raiz do monorepo
colorSchema: dark                # não alterar

# Metadados da aula
title: "Técnico em IA — Aula 37"  # título da janela/aba do browser
...
# Aula 37
## Copa Analytics Dia 2 — Pandas e Desvio Padrão
