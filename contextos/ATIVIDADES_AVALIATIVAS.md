...
| 27/08/2026 | **Av10-T2 ato 2 fundido num instrumento único** e A51 rebalanceada | Dois motivos. (1) A tabela da A51 em `semana13.md` alocava UC07 3h+3h e deixava UC04 sem HA, contrariando a Rotação 3-Sex; a aula é UC07 + UC04, 3 HA cada. (2) O professor confirmou que a turma não entrega a tarefa da A50, que era a entrada do Ind.4, e avaliou os enunciados como rasos demais ("dá pra fazer em 10 minutos, principalmente com ChatGPT"). Ind.4 e Ind.7 passam a ser cobrados num instrumento só, em papel, sem celular, consulta apenas ao caderno: um cenário de app de adoção oferecido ao abrigo, com série de adoções para o aluno calcular a coluna de crescimento, diagnosticar a fase da curva, classificar melhoria/ruptura, seguir um dado pelas 7 etapas de Beal, decidir prazo de descarte com cargo aprovador, e defender por escrito contra uma afirmação dada. Resistente a IA por depender de números que o próprio aluno calculou e de artefatos das A47/A50. O slot de UC04 recebe conteúdo real (tópico 7, métricas de avaliação) em vez de só recuperação. |
...
## Plano de Avaliações — T2 2026

> Trimestre T2: início 21/05/2026 (A26) · fim 04/09/2026 (A53). Calendário completo em [roteiro-t2](roteiro-t2.md) · rotação em [horario-rotacao-t2](semanas/horario-rotacao-t2.md) · indicadores em [indicadores-t2](indicadores-t2.md).
> Numeração de aulas corrigida em 29/07/2026: A41 já havia sido dado (10/07) — a partir daí segue A42→A53, sem reuso de código.
> Status "⏳ Pendente" em todas as linhas — nenhuma destas avaliações foi aplicada ainda. Regra "Status nunca retroativo" (Schema 4 de `_schemas.md`).
