...
Liste 3–5 sinergias entre UCs que aparecem na mesma semana — use as seções "Conexões com Outras Disciplinas" dos agentes UC correspondentes em `.github/agents/uc0X-*.agent.md`.
