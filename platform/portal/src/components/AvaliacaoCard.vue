...
function handleClick() {
  if (disponivel.value) router.push(`/avaliacao/${props.avaliacao.slug}`)
}
</script>
  ...
  >
    <div class="flex items-center justify-between gap-4">
      ...
      <div class="flex items-center gap-2 shrink-0">
        ...
        >Disponível</span>
        <svg v-if="disponivel" class="w-4 h-4 text-gray-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
