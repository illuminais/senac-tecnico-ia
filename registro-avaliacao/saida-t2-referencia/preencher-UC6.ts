 ...
 * Aba:    UC6  (UC09 na planilha do instrutor — Estatística Aplicada e Lógica Matemática)
 * Gerado: 2026-09-04
 *
...
const ABA_REGISTRO = "UC6- Registro de Avaliação 2º";
const ABA_FB_IND = "UC6 - Feedback de Indicador";
const ABA_FB_PROC = "UC6 - Feedback de Processo";
...
const FRASES: Record<string, Record<string, string>> = {
    ...
    "4": {
        "A": "Compreende e aplica funções matemáticas exponenciais.",
        "PA": "Compreende e aplica parcialmente funções matemáticas exponenciais.",
        "NA": "Não compreende e não aplica adequadamente funções matemáticas exponenciais.",
        "NAV": "Não houve evidências suficientes para avaliação deste indicador."
    },
    "5": {
        "A": "Interpreta e aplica probabilidades básicas.",
        "PA": "Interpreta e aplica parcialmente probabilidades básicas.",
        "NA": "Não interpreta e não aplica adequadamente probabilidades básicas.",
        "NAV": "Não houve evidências suficientes para avaliação deste indicador."
    },
    "6": {
        "A": "Compreende variável qualitativa e quantitativa.",
        "PA": "Compreende parcialmente variável qualitativa e quantitativa.",
        "NA": "Não compreende adequadamente variável qualitativa e quantitativa.",
        "NAV": "Não houve evidências suficientes para avaliação deste indicador."
    },
    "7": {
        "A": "Aplica dados discretos e contínuos.",
        "PA": "Aplica parcialmente dados discretos e contínuos.",
        "NA": "Não aplica adequadamente dados discretos e contínuos.",
        "NAV": "Não houve evidências suficientes para avaliação deste indicador."
    }
};
