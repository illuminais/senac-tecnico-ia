 ...
 * Aba:    UC8  (UC02 na planilha do instrutor — Inglês Instrumental)
 * Gerado: 2026-09-04
 *
...
const ABA_REGISTRO = "UC8 - Registro de Avaliação 2º";
const ABA_FB_IND = "UC8 - Feedback de Indicador";
const ABA_FB_PROC = "UC8 - Feedback de Processo";
...
const FRASES: Record<string, Record<string, string>> = {
    "1": {
        "A": "Reconhece vocabulário técnico em inglês presente em softwares, interfaces digitais e ambientes de programação.",
        "PA": "Reconhece parcialmente vocabulário técnico em inglês presente em softwares, interfaces digitais e ambientes de programação.",
        "NA": "Não reconhece adequadamente vocabulário técnico em inglês presente em softwares, interfaces digitais e ambientes de programação.",
        "NAV": "Não houve evidências suficientes para avaliação deste indicador."
    },
    "2": {
        "A": "Interpreta instruções simples em inglês em manuais, menus e tutoriais de tecnologia.",
        "PA": "Interpreta parcialmente instruções simples em inglês em manuais, menus e tutoriais de tecnologia.",
        "NA": "Não interpreta adequadamente instruções simples em inglês em manuais, menus e tutoriais de tecnologia.",
        "NAV": "Não houve evidências suficientes para avaliação deste indicador."
    },
    "3": {
        "A": "Utiliza estratégias básicas de leitura para compreender textos técnicos curtos.",
        "PA": "Utiliza parcialmente estratégias básicas de leitura para compreender textos técnicos curtos.",
        "NA": "Não utiliza adequadamente estratégias básicas de leitura para compreender textos técnicos curtos.",
        "NAV": "Não houve evidências suficientes para avaliação deste indicador."
    }
};
