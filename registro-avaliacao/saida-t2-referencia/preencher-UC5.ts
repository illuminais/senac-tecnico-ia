 ...
 * Aba:    UC5  (UC08 na planilha do instrutor — Desenvolvimento de Banco de Dados)
 * Gerado: 2026-09-04
 *
...
const ABA_REGISTRO = "UC5- Registro de Avaliação 2º";
const ABA_FB_IND = "UC5 - Feedback de Indicador";
const ABA_FB_PROC = "UC5 - Feedback de Processo";
...
const FRASES: Record<string, Record<string, string>> = {
    "3": {
        "A": "Cria a estrutura física de banco de dados, de acordo com os requisitos da aplicação e da modelagem de dados.",
        "PA": "Cria parcialmente a estrutura física de banco de dados, de acordo com os requisitos da aplicação e da modelagem de dados.",
        "NA": "Não cria adequadamente a estrutura física de banco de dados, de acordo com os requisitos da aplicação e da modelagem de dados.",
        "NAV": "Não houve evidências suficientes para avaliação deste indicador."
    },
    "4": {
        "A": "Gerencia a permissão de acesso ao banco de dados, de acordo com o perfil do usuário e as políticas de acesso.",
        "PA": "Gerencia parcialmente a permissão de acesso ao banco de dados, de acordo com o perfil do usuário e as políticas de acesso.",
        "NA": "Não gerencia adequadamente a permissão de acesso ao banco de dados, de acordo com o perfil do usuário e as políticas de acesso.",
        "NAV": "Não houve evidências suficientes para avaliação deste indicador."
    },
    "5": {
        "A": "Cria e manipula consultas SQL de forma adequada para resolução de problemas.",
        "PA": "Cria e manipula parcialmente consultas SQL para resolução de problemas.",
        "NA": "Não cria e não manipula adequadamente consultas SQL para resolução de problemas.",
        "NAV": "Não houve evidências suficientes para avaliação deste indicador."
    }
};
