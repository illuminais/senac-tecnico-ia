 ...
 * Aba:    UC7  (UC01 na planilha do instrutor — Fundamentos de Computação)
 * Gerado: 2026-09-04
 *
...
const ABA_REGISTRO = "UC7 - Registro de Avaliação 2º";
const ABA_FB_IND = "UC7 - Feedback de Indicadores";
const ABA_FB_PROC = "UC7 - Feedback de Processo";
...
const FRASES: Record<string, Record<string, string>> = {
    "3": {
        "A": "Aplica estratégias de edição e revisão para solucionar problemas de digitação e estrutura em documentos.",
        "PA": "Aplica parcialmente estratégias de edição e revisão para solucionar problemas de digitação e estrutura em documentos.",
        "NA": "Não aplica adequadamente estratégias de edição e revisão para solucionar problemas de digitação e estrutura em documentos.",
        "NAV": "Não houve evidências suficientes para avaliação deste indicador."
    },
    "4": {
        "A": "Acessa e utiliza navegadores de internet com segurança, realizando pesquisas por meio de palavras-chave e critérios de confiabilidade.",
        "PA": "Acessa e utiliza parcialmente navegadores de internet com segurança, realizando pesquisas por meio de palavras-chave e critérios de confiabilidade.",
        "NA": "Não acessa e não utiliza adequadamente navegadores de internet com segurança, realizando pesquisas por meio de palavras-chave e critérios de confiabilidade.",
        "NAV": "Não houve evidências suficientes para avaliação deste indicador."
    },
    "5": {
        "A": "Organiza e armazena informações digitais de forma lógica e coerente, demonstrando autonomia e criticidade.",
        "PA": "Organiza e armazena parcialmente informações digitais de forma lógica e coerente, demonstrando autonomia e criticidade.",
        "NA": "Não organiza e não armazena adequadamente informações digitais de forma lógica e coerente, demonstrando autonomia e criticidade.",
        "NAV": "Não houve evidências suficientes para avaliação deste indicador."
    }
};
