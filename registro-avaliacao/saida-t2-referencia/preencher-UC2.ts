 ...
 * Aba:    UC2  (UC05 na planilha do instrutor — Desenvolvimento de Linguagem Python)
 * Gerado: 2026-09-04
 *
...
const ABA_REGISTRO = "UC2 - Registro de Avaliação 2º";
const ABA_FB_IND = "UC2 - Feedback de Indicadores";
const ABA_FB_PROC = "UC2 - Feedback de Processo";
...
const FRASES: Record<string, Record<string, string>> = {
    "2": {
        "A": "Utiliza comandos de integração dos códigos construídos em Python, conforme estrutura projetada.",
        "PA": "Utiliza parcialmente comandos de integração dos códigos construídos em Python, conforme estrutura projetada.",
        "NA": "Não utiliza adequadamente comandos de integração dos códigos construídos em Python, conforme estrutura projetada.",
        "NAV": "Não houve evidências suficientes para avaliação deste indicador."
    },
    "3": {
        "A": "Realiza a depuração, verificando e corrigindo erros na programação, de acordo com recomendação técnica.",
        "PA": "Realiza parcialmente a depuração, verificando e corrigindo erros na programação, de acordo com recomendação técnica.",
        "NA": "Não realiza adequadamente a depuração, verificando e corrigindo erros na programação, de acordo com recomendação técnica.",
        "NAV": "Não houve evidências suficientes para avaliação deste indicador."
    }
};
